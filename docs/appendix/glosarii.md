...
### Activity
A category of action that typically takes more than a single action. Activities on your turn take 2 actions (![two-actions](../../source/img/action_double.png)) or 3 actions (![three-actions](../../source/img/action_tripple.png)). Exploration and downtime activities can take minutes, hours, or days
### Additive (trait)
...
### Administer First Aid (![two-actions](../../source/img/action_double.png)) (skill action)
...
### Aid (![reaction](../../source/img/action_reaction.png)) (basic action)
...
### Arrest a Fall (![reaction](../../source/img/action_reaction.png)) (specialty basic action)
...
### Attack of Opportunity (![reaction](../../source/img/action_reaction.png))
...
### Avert Gaze (![one-action](../../source/img/action.png)) (specialty basic action)
...
### Balance (![one-action](../../source/img/action.png)) (skill action)
...
### Bulwark (armor trait)
### Burrow (![one-action](../../source/img/action.png)) (specialty basic action)
...
### Climb (![one-action](../../source/img/action.png)) (skill action)
...
### Command an Animal (![one-action](../../source/img/action.png)) (skill action)
...
### Conceal an Object (![one-action](../../source/img/action.png)) (skill action)
...
### Counterspell (![reaction](../../source/img/action_reaction.png))
...
### Crawl (![one-action](../../source/img/action.png)) (basic action)
Move 5 feet while prone.
### Create a Diversion (![one-action](../../source/img/action.png)) (skill action)
...
### Delay (![free-action](../../source/img/action_free.png))(basic action)
...
### Demoralize (![one-action](../../source/img/action.png)) (skill action)
...
### Disable a Device (![two-actions](../../source/img/action_double.png)) (skill action)
Disable a trap or a similar complex mechanism. (Thievery, trained)
### Disarm (weapon trait)
### Disarm (![one-action](../../source/img/action.png)) (skill action)
...
### Dismiss (![one-action](../../source/img/action.png)) (action)
...
### Drop Prone (![one-action](../../source/img/action.png)) (basic action)
...
### Escape (![one-action](../../source/img/action.png)) (basic action)
...
### Feint (![one-action](../../source/img/action.png)) (skill action)
...
### Fly (![one-action](../../source/img/action.png)) (specialty basic action)
...
### Force Open (![one-action](../../source/img/action.png)) (skill action)
...
### Free action (![free-action](../../source/img/action_free.png))
...
### Gp (gold piece)
### Grab an Edge (![reaction](../../source/img/action_reaction.png)) (specialty basic action)
Try to catch yourself while falling.
### Grabbed (condition)
A creature, object, or magic holds you in place.
### Grapple (![one-action](../../source/img/action.png)) (skill action)
...
### Hide (![one-action](../../source/img/action.png)) (skill action)
Make yourself hidden. (Stealth)
### High Jump (![two-actions](../../source/img/action_double.png)) (skill action)
...
### Interact (![one-action](../../source/img/action.png)) (basic action)
...
### Leap (![one-action](../../source/img/action.png)) (basic action)
...
### Long Jump (![two-actions](../../source/img/action_double.png)) (skill action)
...
### Maneuver in Flight (![one-action](../../source/img/action.png)) (skill action)
...
### Mount (![one-action](../../source/img/action.png)) (specialty basic action)
...
### Palm an Object (![one-action](../../source/img/action.png)) (skill action)
...
### Pick a Lock (![two-actions](../../source/img/action_double.png)) (skill action)
...
### Point Out (![one-action](../../source/img/action.png)) (specialty basic action)
...
### Rage (trait)
### Raise a Shield (![one-action](../../source/img/action.png)) (specialty basic action)
...
### Reach (weapon trait)
### Reaction (![reaction](../../source/img/action_reaction.png))
An action you can use even if it’s not your turn. You can use 1 reaction per round.
### Ready (![two-actions](../../source/img/action_double.png)) (basic action)
Prepare an action to use when it’s not your turn.
### Recall Knowledge (![one-action](../../source/img/action.png)) (skill action)
...
### Release (![free-action](../../source/img/action_free.png))(basic action)
...
### Request (![one-action](../../source/img/action.png)) (skill action)
...
### Seek (![one-action](../../source/img/action.png)) (basic action)
Scan an area for creatures or objects using Perception.
### Sense Direction (![one-action](../../source/img/action.png)) (skill action)
Figure out your precise location. (Survival)
### Sense Motive (![one-action](../../source/img/action.png)) (basic action)
...
### Shove (![one-action](../../source/img/action.png)) (skill action)
...
### Sneak (![one-action](../../source/img/action.png)) (skill action)
...
### Stand (![one-action](../../source/img/action.png)) (basic action)
Stand up from prone.
### Status Bonus
...
### Steal (![one-action](../../source/img/action.png)) (skill action)
Pilfer an object in someone else’s possession. (Thievery)
### Stealth (skill)
Avoid detection and conceal items. (Dex)
### Step (![one-action](../../source/img/action.png)) (basic action)
Move 5 feet without triggering reactions.
### Strength (Str)
This ability score measures your brawn.
### Stride (![one-action](../../source/img/action.png)) (basic action)
Move up to your Speed.
### Strike (![one-action](../../source/img/action.png)) (basic action)
...
### Support (![one-action](../../source/img/action.png))
Direct your animal companion to support you.
### Survival (skill)
Travel and survive in the wild. (Wis)
### Sustain a Spell (![one-action](../../source/img/action.png)) (action)
Extend a spell with a sustained duration.
### Sustain an Activation (![one-action](../../source/img/action.png)) (action)
...
### Swim (![one-action](../../source/img/action.png)) (skill action)
Move through the water. (Athletics)
### Take Cover (![one-action](../../source/img/action.png)) (basic action)
...
### Treat Poison (![one-action](../../source/img/action.png)) (skill action)
...
### Trip (![one-action](../../source/img/action.png)) (skill action)
Knock a creature down. (Athletics)
### Tumble Through (![one-action](../../source/img/action.png)) (skill action)
